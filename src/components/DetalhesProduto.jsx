...
function DetalhesProduto({ produto, onFechar, listaAtiva, itemDaLista }) {
        ...
        >
            ...
            {MERCADOS.map((m) => (
              <button
                ...
                style={{
                  padding: "10px",
                  borderRadius: "10px",
                  border: `2px solid ${mercado === m ? "var(--laranja)" : "#DEE2E6"}`,
                  background: mercado === m ? cor + "22" : "var(--card)",
                  color: mercado === m ? "var(--laranja)" : "var(--text)",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: RAIO.md,
              border: "none",
              background: !mercado || !preco ? "#DEE2E6" : "var(--laranja)",
            ...
            {historico.map((h, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "10px 0",
                  borderBottom:
                    i < historico.length - 1 ? "1px solid #F1F3F5" : "none",
                }}
              >
                <div>
